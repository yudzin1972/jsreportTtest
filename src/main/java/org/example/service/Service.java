...
public class Service {
    public void generateReport() {
        ...
        unitList.add(new Unit("111111", "2111122222", "3333333333","fffff"));
        unitList.add(new Unit("aaaaaaa", "2111122222", "3333333333","ghbnjh"));
        unitList.add(new Unit("sssssss", "2111122222", "3333333333","445"));
        unitList.add(new Unit("ddddddddddddd ffffffffffff gggg", "2111122222", "3333333333","544"));
        unitList.add(new Unit("zzzzzzzzzz x cccccccc", "2111122222", "3333333333","fgh66"));
        unitList.add(new Unit("111111", "2111122222", "3333333333","fffff"));
        unitList.add(new Unit("aaaaaaa", "2111122222", "3333333333","ghbnjh"));
        unitList.add(new Unit("sssssss", "2111122222", "3333333333","445"));
        unitList.add(new Unit("ddddddddddddd ffffffffffff gggg", "2111122222", "3333333333","544"));
